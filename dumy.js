...
// pakistan();
// function Qadoos(){
//     console.log("He is my sweet son.");
// }
// Qadoos();
// function jada(){
//     return  "Jhelum"
// }
// let name1:string = jada()
// console.log(name1);
// function Ashir(){
//     return 123
// }
...
// console.log(s);
// function England(){
//     console.log("Ab kay hum bicharay to shaid ");
// }
// England();
// function school(){
//     return 2961
...
//     return sum;
// }
// let x:number = arrowfuntion();
// console.log(x);
// function arrowfuntion(){
//     console.log("High way to heaven")
// }
// arrowfuntion();
// arrowfuntion();
// arrowfuntion();
...
//    hobbies:["aa", "bb", "CC"]
//    salary:()=>  "month",
//    email:"mgulraiz00@gmail.com"
// }
// delete ali.salary 
// ali.adress = "house#306.NR masjid mochian jada jhelum",
// console.log(ali)
// let x:number = Math.round(10.3);
// console.log(x);
// interface Person {
//     name:string;
//     age:number;
...
//     id:number
// }
// interface shopkeeper extends employee {
//     adress:string
// }
// let person:person = {
//     name:"Ali",
...
// const medical3 = new medical("Gulraiz",100,"scientist","river","18years","daryala jhelum")
// console.log(medical1,medical2,medical3)
// class medical{
//     name:string;
//     age:number;
//     qualification:string;
...
// console.log(x)
// enum students {
//     Ali,Bilal,Qadoos,AAsshir,school
// }
// const x:student= students.Qadoos
// console.log(x)
// enum pakistan {
...
// console.log(x)
// enum pakistan {
//     pujab=91, sindh, peshawar, koita, murree
// }
// const x:pakistan= pakistan.sindh
// const y: string = pakistan[95]
// console.log(y)
// // console.log(x)
// // while and do loop
// let i =1
...
//             return this.answer = n1 / n2
//         }
//         tan(n1:number,n2:number):number{
//             return this.answer=tan(n1*n2)
//         }        
// }
// const calculator1 = new calculator(0);
// let x = calculator1.tan(2,15)
// console.log(x)
//     class calculator{
//         n1 : number
//         n2 : number
...
// ====================================================================================
class rooms {
    constructor(name, door, qty, windows) {
        this.name = name,
            this.door = door,
            this.qty = qty,
